...
Gui, Add, Text, x2 x20 y80 w300 h15 , ALT + NumPad2 - Cлежку
...
Gui, Add, Text, x2 x20 y125 w300 h15 , ALT + NumPad5 - Направить игрока на Province.info
Gui, Add, Text, x2 x20 y140 w300 h15 , ALT + NumPad6 - Направить игрока в тех. поддержка
Gui, Add, Text, x2 x20 y155 w300 h15 , ALT + NumPad7 - Оставить ЖБ на форуме
Gui, Add, Text, x2 x20 y170 w300 h15 , CTRL + NumPad8 - Оставить ОБЖ на форуме
Gui, Add, Text, x2 x20 y185 w300 h15 , ALT + NumPad8 - Предпредить игрока соблюдать ПДД
...
Gui, Add, Text, x2 x380 y80 w300 h15 , [Открыть F8] /епп - посать игрока за ЕПП
Gui, Add, Text, x2 x380 y95 w300 h15 , [Открыть F8] /епт - посать игрока за ЕПТ/газонам
Gui, Add, Text, x2 x380 y110 w300 h15 , [Открыть F8] /красные - посать игрока за красный х2
Gui, Add, Text, x2 x380 y125 w300 h15 , [Открыть F8] /встречка - посать игрока на встречку
Gui, Add, Text, x2 x380 y140 w300 h15 , [Открыть F8] /чит - забанить по нику за читы
Gui, Add, Text, x2 x380 y155 w300 h15 , /афк - Проверка на AFK
...
Gui 1:Font, s8 c000000 Bold, Arial
Gui, Add, Text, x20 y60 w200 h15, /атп - АТП в gps
Gui, Add, Text, x20 y75 w200 h15, /сто - Автомастерская
Gui, Add, Text, x20 y90 w200 h15 , /аэропорт - Аэропорт
Gui, Add, Text, x20 y105 w200 h15 , /банк - Банк
Gui, Add, Text, x20 y120 w200 h15 , /дорожная служба - Дорожная служба
Gui, Add, Text, x20 y135 w200 h15 , /жбк - Завод ЖБК 
Gui, Add, Text, x20 y150 w200 h15 , /лесопилка - Лесопилка(Жуковский) 
Gui, Add, Text, x20 y165 w200 h15 , /трамвай - Трамвайное депо 
Gui, Add, Text, x20 y180 w200 h15 , /тк - Транспортная компания 
Gui, Add, Text, x20 y195 w200 h15 , /стройка - Стройплощадка 
Gui, Add, Text, x20 y210 w200 h15 , /такси - Таксопарк
Gui, Add, Text, x20 y225 w200 h15 , /шахта - Шахта 
Gui, Add, Text, x20 y240 w200 h15 , /вту - ВТУ (Волчанск)
Gui, Add, Text, x20 y255 w200 h15 , /красный октябрь - Завод "Красный Октябрь"
Gui, Add, Text, x20 y270 w200 h15 , /табачка - Табачный завод
...
Gui 1:Font, s8 c000000 Bold, Arial
Gui, Add, Text, x280 y60 w200 h15 , /больница - Больница
Gui, Add, Text, x280 y75 w200 h15 , /военкомат - Военкоман
Gui, Add, Text, x280 y90 w200 h15 , /полиция - Полицейский участок
Gui, Add, Text, x280 y105 w200 h15 , /вч - Воинская часть
Gui, Add, Text, x280 y120 w200 h15 , /ржд - Здание РЖД
Gui, Add, Text, x280 y135 w200 h15 , /отдых - Магазин "Все для отдыха"
Gui, Add, Text, x280 y150 w200 h15 , /автомагазин - Автомагазин
Gui, Add, Text, x280 y165 w200 h15 , /скупщик - Скупщик рыбы и грибов
Gui, Add, Text, x280 y180 w200 h15 , /автосалон - Автосалон
Gui, Add, Text, x280 y195 w200 h15 , /автостоянка - Автостоянка
Gui, Add, Text, x280 y210 w200 h15 , /маэс - МАЭС
Gui, Add, Text, x280 y225 w200 h15 , /стадион - Стадион Мирный
Gui, Add, Text, x280 y240 w200 h15 , /летная школа - Летная школа
Gui, Add, Text, x280 y255 w200 h15 , /водная школа - Водная школа
Gui, Add, Text, x280 y270 w200 h15 , /гостиница - Гостиница
Gui, Add, Text, x280 y285 w200 h15 , /хранилище - Хранилище
Gui, Add, Text, x280 y300 w200 h15 , /порт - Морской порт Невского
Gui, Add, Text, x280 y315 w200 h15 , /офис - Офисный центр
Gui, Add, Text, x280 y330 w200 h15 , /гтрек - Гоночный трек
Gui, Add, Text, x280 y345 w200 h15 , /ттрек - Тестовый трек
Gui, Add, Text, x280 y360 w200 h15 , /лента - ТЦ "Лента"
Gui, Add, Text, x280 y375 w200 h15 , /вивалэнд - ТРК "ВиваЛэнд"
Gui, Add, Text, x280 y390 w200 h15 , /цветы - Цветочная лавка Николая
Gui, Add, Text, x280 y405 w200 h15 , /аренда - Аренда авто/великов/лодок
Gui, Add, Text, x280 y420 w200 h15 , /бар - Бар Приволжск/Мирный
Gui, Add, Text, x280 y435 w200 h15 , /пк - Компьютерный клуб
Gui, Add, Text, x280 y450 w200 h15 , /спортзал - Спортивный зал
Gui, Add, Text, x280 y465 w200 h15 , /парашют - Прыжок с парашютом
Gui, Add, Text, x280 y480 w200 h15 , /тир - Тир
...
Gui, Add, Text, x720 y785 w780 h30 , by Stich_Allen 
Gui, Font, S9
...
^numpad7::
SendMessage, 0x50,, 0x4190419,, A 
SendPlay {space}Обжалуйте наказание на форуме - https://vk.cc/cyNCSD {enter}
return
